...
import {formResponseStore} from './src/store/FormResponseStore';
...
import {SyncScreen} from './src/screens';
...
const DrawerContent = observer(() => {
  ...
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen
        name={ROUTES.SYNC}
        component={gestureHandlerRootHOC(SyncScreen)}
        options={{
          headerStyle: styles.headerWithoutDivider,
          title: 'Sync',
        }}
      ...
      <Drawer.Screen
        name={ROUTES.SESSION}
        component={gestureHandlerRootHOC(SessionNavigator)}
        options={{
          headerShown: false,
          title: 'Session',
        }}
...
const App = observer(() => {
  ...
  // Clear any stale form drafts from a previous session on every cold start.
  // Deferred until after the initial transition completes so it doesn't
  // compete with animation frames.
  React.useEffect(() => {
                ...
                <BottomSheetModalProvider>
                  <Stack.Navigator
                    ...
                    <Stack.Screen
                      ...
                      options={{
                        // Fade instead of slide for Login→Main.
                        // The iOS slide waits for the full DrawerNavigator to
                        // initialise before completing; a short fade is instant.
                        animation: 'fade',
                      }}
                    />
                  </Stack.Navigator>
