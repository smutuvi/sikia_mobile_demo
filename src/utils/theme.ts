...
// Align primary palette with Sikia Flutter app (Color(0xFF2E7D32)).
const md3BaseColors: Partial<MD3BaseColors> = {
  // Sikia primary green
  primary: '#2E7D32',
  // Deeper green accent
  secondary: '#1B5E20',
  // Soft green for tertiary accents
  tertiary: '#A5D6A7',
  error: '#FF653F',
};
...
const createBaseColors = (appTheme: AppTheme): MD3BaseColors => {
  ...
  return {
    ...
    surface: '#F9FAFB',
    onSurface: '#333333',
    surfaceVariant: '#E4EDE6',
    onSurfaceVariant: '#4B6354',
    outline: withOpacity(md3BaseColors.primary!, 0.08),
    outlineVariant: '#a1a1a1',
    // Additional required MD3 colors
