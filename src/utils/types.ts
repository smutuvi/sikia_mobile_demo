...
/**
 * ASR model representation (currently Whisper ggml binaries).
 * Kept separate from LLM `Model` because the UI + lifecycle is different.
 */
export interface AsrModel {
  ...
  downloadSpeed?: string;
  origin: AsrModelOrigin;
  fullPath?: string; // full path when downloaded/added locally
}
...
/**
 * Context initialization parameters for Sikia AI
