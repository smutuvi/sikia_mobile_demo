...
export class UIStore {
  ...
  // Default to light mode (user can enable dark mode in Settings)
  ...
  // Global speech input mode for interviews and voice features
  sttMode: 'offline' | 'online' = 'offline';
  ...
  showError(message: string) {
    ...
    try {
      ...
      // In case Alert is not available (e.g. during tests), ignore
    }
  }
  ...
  setSttMode(mode: 'offline' | 'online') {
    runInAction(() => {
      this.sttMode = mode;
    });
  }
