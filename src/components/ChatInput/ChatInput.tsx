...
export interface ChatInputTopLevelProps {
  ...
  /** Voice input (OpenAI Whisper): show mic button when true */
  ...
  onStartVoice?: () => void;
  onStopVoice?: () => void;
  /** Short status for voice (e.g. "Listening…", "Processing…") */
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.controlBar}>
            ...
            <View style={styles.leftControls}>
              ...
              {/* Voice input (OpenAI Whisper): tap to start, tap again to stop */}
              {showVoiceInput && !isVideoCapable && onStartVoice && onStopVoice && (
                <>
                  <IconButton
                    icon="microphone"
                    size={20}
                    ...
                    disabled={isVoiceTranscribing && !isVoiceRecording}
                    style={[
                      styles.micButton,
                      isVoiceRecording && {
                  ...
                  {voiceStatusLabel ? (
                    <Text
                      style={[
                        ...
                        {color: onSurfaceColorVariant, marginLeft: 0},
                      ]}
                      numberOfLines={1}>
                      {voiceStatusLabel}
                    </Text>
